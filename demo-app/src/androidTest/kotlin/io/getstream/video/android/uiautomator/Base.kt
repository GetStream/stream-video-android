 ...
 */
public val device: UiDevice get() = UiDevice.getInstance(
    io.getstream.video.android.uiautomator.instrumentation,
)
 ...
 */
public val testAssets: AssetManager = io.getstream.video.android.uiautomator.testContext.assets
 ...
 */
public val resources: Resources get() = io.getstream.video.android.uiautomator.appContext.resources

/**
 * Application package name.
 */
public val packageName: String get() = io.getstream.video.android.uiautomator.appContext.packageName.removeSuffix(
    ".test",
)

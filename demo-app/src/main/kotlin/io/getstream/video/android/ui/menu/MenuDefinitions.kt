...
fun defaultStreamMenu(
    ...
    add(getCCActionMenu(closedCaptionState, onToggleClosedCaptions))
}
...
fun getCCActionMenu(
    ...
    return when (closedCaptionState) {
        is ClosedCaptionState.Available -> {
            ActionMenuItem(
        ...
        is ClosedCaptionState.UnAvailable -> {
            ActionMenuItem(

...
sealed class ModerationUiState {
    ...
    data object Visible : ModerationUiState()

    data object NotVisible : ModerationUiState()

//    public fun TranscriptionSettingsResponse.ClosedCaptionMode.toClosedCaptionUiState(): ModerationUiState {
//        return when (this) {

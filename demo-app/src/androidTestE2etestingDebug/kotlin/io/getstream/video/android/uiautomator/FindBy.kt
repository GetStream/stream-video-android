...
public fun BySelector.findObject(): UiObject2 {
    return io.getstream.video.android.uiautomator.device.findObject(this)
}
...
public fun BySelector.findObjects(): List<UiObject2> {
    return io.getstream.video.android.uiautomator.device.findObjects(this)
}
 ...
 */
public infix fun UiDevice.findObjectByTextContains(
    text: String,
): UiObject2 = findObject(By.textContains(text))

...
subprojects {
    pluginManager.withPlugin("io.getstream.android.library") {
        configure<io.getstream.core.android.StreamAndroidExtension> {
    ...
    pluginManager.withPlugin("io.getstream.android.application") {
        configure<io.getstream.core.android.StreamAndroidExtension> {
            compileSdk(libs.versions.compileSdk.get().toInt())
            minSdk(libs.versions.minSdk.get().toInt())
            targetSdk(libs.versions.targetSdk.get().toInt())
            appVersionName(io.getstream.video.android.Configuration.versionName)
        }
    }

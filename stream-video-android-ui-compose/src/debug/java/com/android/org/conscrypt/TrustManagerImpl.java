 ...
 * include conscrypt's {@code TrustManagerImpl}. Previews that build the preview {@code StreamVideo}
 * construct a real {@link okhttp3.OkHttpClient}; OkHttp then selects {@code Android10Platform} and
 * constructs {@code android.net.http.X509TrustManagerExtensions}, which references this class —
 * throwing {@code NoClassDefFoundError} that OkHttp does not catch, so the preview fails to render.
 *

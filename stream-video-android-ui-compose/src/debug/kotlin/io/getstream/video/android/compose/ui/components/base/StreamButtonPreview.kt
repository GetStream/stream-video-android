...
@Preview
@Composable
private fun RegularIconButtonsRootPreview() {
    VideoTheme {
...
@Composable
internal fun RegularIconButtonsPreview() {
    Column {
        Row {
            StreamIconButton(
...
@Preview
@Composable
private fun RegularButtonsRootPreview() {
    VideoTheme {
...
@Composable
internal fun RegularButtonsPreview() {
    Column {
        // Default
        StreamButton(
            text = "Primary Button",
...
@Preview
@Composable
private fun ButtonWithIconsRootPreview() {
    VideoTheme {
...
@Composable
internal fun ButtonWithIconsPreview() {
    Column {
        // With icon
        StreamButton(
...
@Preview
@Composable
private fun DifferentSizeButtonsRootPreview() {
    VideoTheme {
...
@Composable
internal fun DifferentSizeButtonsPreview() {
    Column {
        // Size
        Spacer(modifier = Modifier.height(24.dp))
        StreamButton(
...
@Preview
@Composable
private fun ToggleIconButtonsRootPreview() {
    VideoTheme {
...
@Composable
internal fun ToggleIconButtonsPreview() {
    Row {
        // Size
...
@Preview
@Composable
private fun ToggleButtonsRootPreview() {
    VideoTheme {
...
@Composable
internal fun ToggleButtonsPreview() {
    Column {
        // Size
        StreamToggleButton(
...
@Preview
@Composable
private fun ShowProgressIntoIconButtonsRootPreview() {
    VideoTheme {
...
@Composable
internal fun ShowProgressIntoIconButtonsPreview() {
    Column {

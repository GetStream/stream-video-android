...
package io.getstream.video.android.xml.ui.font
...
internal class VideoFontsImpl(
    private val style: VideoStyle,
    ...
    private val logger = StreamLog.getLogger("Call:VideoFonts")

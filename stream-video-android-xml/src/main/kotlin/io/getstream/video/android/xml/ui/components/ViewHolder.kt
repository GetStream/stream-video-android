...
import io.getstream.video.android.xml.databinding.AdapterItemBinding
...
internal class ItemViewHolder(
    ...
    fun bind(position: Int) {
        ...
        binding.root.background = ColorDrawable(colors[colorIndex])
        binding.positionView.text = position.toString()
    }
}

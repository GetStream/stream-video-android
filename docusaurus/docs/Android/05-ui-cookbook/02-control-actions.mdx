...
Stream UI components, such as [CallContent](../04-ui-components/04-call/01-call-content.mdx), [CallContent](../04-ui-components/04-call/03-call-content.mdx), and [CallLobby](06-lobby-preview.mdx) provide default control actions like the below:

...
Stream SDK provides the basic incoming and outgoing Call with the [RingingCallContent](../04-ui-components/04-call/04-ringing-call.mdx) component. We can breaks it down one by one:

...
:::note
This cookbook tutorial will skip how to join a livestream call. If you didn't learn about the ![Livestream Tutorial](../02-tutorials/03-livestream.mdx), we're highly recommend you to read about the tutorial first.
:::

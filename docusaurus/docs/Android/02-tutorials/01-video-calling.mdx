...
(We also have a core SDK for video that excludes compose if you use XML layouts)
            ...
            VideoTheme {
                ...
                Column(
                    ...
                    if (connection.value != RealtimeConnection.Connected) {
                        Text("loading...", style=VideoTheme.typography.body)
                    } else {
                        Text("Call ${call.id} has ${participants.value.size} participants", style=VideoTheme.typography.body)
                    }
                }
            }
        }

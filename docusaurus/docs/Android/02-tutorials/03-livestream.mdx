...
### Step 6 - Viewing a livestream (HLS)
...
** Custom events ** You can use custom events on the call to share any additional data.
** Reactions ** Users can react to the livestream

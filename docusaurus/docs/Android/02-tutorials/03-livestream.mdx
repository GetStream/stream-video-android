...
The compose layout is vanilla compose other than VideoRenderer.
...
* You don't render the local video, but instead render the remote video
...
For this tutorial we'll only cover broadcasting on mobile and watching on web.
You can review the [watching a livestream](../05-ui-cookbook/15-watching-livestream.mdx)) documentation to learn how to watch a livestream on Android.

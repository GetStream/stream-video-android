...
VideoTheme {
    ...
    val durationInDateFormat by call.state.durationInDateFormat.collectAsState()
    ...
    Scaffold(
        ...
        backgroundColor = VideoTheme.colors.appBackground, // Use containerColor in material3
        topBar = {
                ...
                if (!backstage) {
                    Box(
                        ...
                        Text(
                            ...
                            text = "Live for ${durationInDateFormat ?: 0}",
                            color = VideoTheme.colors.textHighEmphasis
                        )
                    }
                }
        ...
        bottomBar = {
            Button(
                colors = ButtonDefaults.buttonColors(
                    ...
                    backgroundColor = VideoTheme.colors.primaryAccent // Use containerColor in material3
                ),
                onClick = {
                    lifecycleScope.launch {

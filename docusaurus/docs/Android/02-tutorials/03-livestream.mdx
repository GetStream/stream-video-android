...
If you want to learn more about building an advanced UIs for hosting/watching a livestream, check out the cookbooks below.

- [Cookbook: Hosting a livestream](../05-ui-cookbook/15-hosting-livestream.mdx)
- [Cookbook: Watching a livestream](../05-ui-cookbook/16-watching-livestream.mdx)
...
### Step 5 - Watching a livestream (WebRTC)

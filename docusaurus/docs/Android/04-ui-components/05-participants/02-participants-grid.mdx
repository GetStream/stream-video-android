...
What can you do with `ParticipantsLayout`:
...
* **Five or more** (4 remote + local): Participants are rendered as a grid of items, in a paginated way. Up to 6 participants per page, with the sorted participant. <!-- what does "with the sorted participant" mean? -->
...
Now that you've learned a lot about the `ParticipantsLayout` internal works, let's see how to use this component.
...
This component is truly versatile and lets you cover almost every use case for video calls, supporting smaller, group based calls, 1:1 calls, large meetings, screen sharing and much more. <!-- much more - what? :) -->

## Customization
<!-- show the layoutType parameter that's mentioned in the page about ParticipantsSpotlight -->

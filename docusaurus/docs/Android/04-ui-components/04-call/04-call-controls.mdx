...
In our [Video Android Tutorial](../../02-tutorials/01-video-calling.mdx), we showcased how to build custom `CallControls` to remove camera and video controls and only feature audio buttons. The result ended up looking something like this:

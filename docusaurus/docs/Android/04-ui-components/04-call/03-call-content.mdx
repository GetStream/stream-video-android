...
| ------- | ------------------------------------------------------------ |
| ![Regular](../../assets/compose_call_container.png) | ![Screen Sharing](../../assets/compose_screensharing.png) |
...
public fun CallContent(
    ...
    callAppBarContent: @Composable (Call) -> Unit = { .. },
    callControlsContent: @Composable (Call) -> Unit = { .. },
...
* `callAppBarContent`: Used to render the AppBar within the Call. This AppBar used to display the connection state of the call, display a back button, and participants details button.

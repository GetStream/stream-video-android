...
The `CallContent` lets you easily build UI when inside a call. It handles the state and actions of enabling and disabling audio/video, speakerphone or video, as well as information about the call participants.
...
If you're looking for guides on how to override and customize this UI, we have various [UI Cookbook](../../06-ui-cookbook) recipes for you and we cover a portion of customization within the [Video Android SDK Tutorial](../../01-basics/01-video-calling.mdx).

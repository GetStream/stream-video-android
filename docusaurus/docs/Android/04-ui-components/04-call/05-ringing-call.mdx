...
<!-- is "ringing" a good term? should we replace it with "direct" or something else? -->
...
You can also compose [CallContent](03-call-content.mdx) inside the `onAcceptedContent` block and show a call screen like the example below:

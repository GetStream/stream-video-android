...
* **appBarContent**: Represents the content that handle a back button and shows the call information, such as the status, the number of participants.
* **controlsContent**: Represents the content that features various controls and actions in a call, such as audio and video handles and leaving a call.

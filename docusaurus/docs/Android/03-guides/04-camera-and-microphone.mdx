...
The speaker allows you to enable/disable the speaker phone and set the volume.
...
If the device is locked or your receive an incoming call many apps pause the camera.

...
val call = client.call("default", "123") {/* call is a verb, should it be named createCall? */}
...
The fields available on the participants are documented [here](https://github.com/GetStream/stream-video-android/blob/main/docusaurus/docs/Android/02-guides/03-call-and-participant-state.mdx#participant-state). {/* broken link */}

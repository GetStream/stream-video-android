...
| HomeActivity                                                 | CallActivity TODO (we need the call screen)                  |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
| ![Home Activity UI](https://user-images.githubusercontent.com/17215808/200299040-93396c6b-41ba-4020-895a-eb22058983d0.png) | ![Home Activity UI](https://user-images.githubusercontent.com/17215808/200299040-93396c6b-41ba-4020-895a-eb22058983d0.png) |
...
To get started with [Stream Video](https://github.com/GetStream/stream-video-android), we have a great [starter project]() that pre-bakes all the boilerplate UI and dependency code for you.

* Make sure to clone the starter project, using its [repository]().
...
1. Persist the the `StreamVideo` client and the  `CredentialsProvider` that let you connect to calls.
...
2. You call `joinCall()` with a hardcoded call type and the user-provided ID.

---
title: Getting Your Stream API KEY
description: How to get your Stream API KEY
---

Stream API Key is the most essential credential that allows you to build your own Chat/Video features for your services. To get the Stream API Key, you can follow the steps below:

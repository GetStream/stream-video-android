...
* `addSocketListener`: Adds a listener instance that will receive all the Call socket events. You can learn more about them in the [socket events guide](../04-guides/03-socket-events.mdx).

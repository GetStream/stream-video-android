...
* `callState`: An easy accessor to our call engine that produces the `StreamCallState`. If you want to learn more about this, check out our [call-engine-state guide](../04-guides/02-call-engine-state.mdx).

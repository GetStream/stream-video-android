...
![messages_screen](https://user-images.githubusercontent.com/17215808/212672433-f6d1d28a-5a95-4b23-973a-55ad7b4cea07.png)
...
![custom_attachments](https://user-images.githubusercontent.com/17215808/212690874-0e034b2e-d427-4e3f-9fb2-c13eeb6b3703.png)
...
This is a larger snippet of code, but in essence it only sets up the the default Video SDK behavior:
...
To log into `StreamVideo`, you, in fact, create the `StreamVideo` instance with a user construct. As long as the instance persists, we consider the user to be "logged in".
...
* Picture-In-Picture when backgrounding

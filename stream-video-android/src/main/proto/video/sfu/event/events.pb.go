...
func (VideoLayerSetting_Priority) EnumDescriptor() ([]byte, []int) {
	return file_video_sfu_event_events_proto_rawDescGZIP(), []int{21, 0}
}
...
var file_video_sfu_event_events_proto_rawDesc = []byte{
	...
	0x6b, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x22, 0x82, 0x01, 0x0a, 0x10,
	...
	0x66, 0x75, 0x2e, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x73, 0x2e, 0x43, 0x61, 0x6c, 0x6c, 0x53, 0x74,
	0x61, 0x74, 0x65, 0x52, 0x09, 0x63, 0x61, 0x6c, 0x6c, 0x53, 0x74, 0x61, 0x74, 0x65, 0x22, 0x76,
	...
	,
	...
	0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x22, 0x5a, 0x0a, 0x0a, 0x41, 0x75, 0x64,
	...
	0x6c, 0x65, 0x76, 0x65, 0x6c, 0x22, 0x5a, 0x0a, 0x11, 0x41, 0x75, 0x64, 0x69, 0x6f, 0x4c, 0x65,
	...
	0x65, 0x6e, 0x64, 0x65, 0x72, 0x73, 0x42, 0x31, 0x42, 0x0b, 0x53, 0x66, 0x75, 0x45, 0x76, 0x65,
	0x6e, 0x74, 0x73, 0x56, 0x31, 0x50, 0x01, 0x5a, 0x0a, 0x73, 0x66, 0x75, 0x5f, 0x65, 0x76, 0x65,
	0x6e, 0x74, 0x73, 0xaa, 0x02, 0x13, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x2e, 0x56, 0x69, 0x64,
...
var file_video_sfu_event_events_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_video_sfu_event_events_proto_goTypes = []interface{}{
	...
	(*AudioLevel)(nil),               // 17: stream.video.sfu.event.AudioLevel
	(*AudioLevelChanged)(nil),        // 18: stream.video.sfu.event.AudioLevelChanged
	(*AudioMediaRequest)(nil),        // 19: stream.video.sfu.event.AudioMediaRequest
	(*AudioSender)(nil),              // 20: stream.video.sfu.event.AudioSender
	(*VideoMediaRequest)(nil),        // 21: stream.video.sfu.event.VideoMediaRequest
	(*VideoLayerSetting)(nil),        // 22: stream.video.sfu.event.VideoLayerSetting
	(*VideoSender)(nil),              // 23: stream.video.sfu.event.VideoSender
	(*ChangePublishQuality)(nil),     // 24: stream.video.sfu.event.ChangePublishQuality
	(*models.ICETrickle)(nil),        // 25: stream.video.sfu.models.ICETrickle
	(*models.Error)(nil),             // 26: stream.video.sfu.models.Error
	(models.PeerType)(0),             // 27: stream.video.sfu.models.PeerType
	(models.TrackType)(0),            // 28: stream.video.sfu.models.TrackType
	(*models.CallState)(nil),         // 29: stream.video.sfu.models.CallState
	(*models.Participant)(nil),       // 30: stream.video.sfu.models.Participant
	(models.ConnectionQuality)(0),    // 31: stream.video.sfu.models.ConnectionQuality
	(*models.Codec)(nil),             // 32: stream.video.sfu.models.Codec
}
var file_video_sfu_event_events_proto_depIdxs = []int32{
	...
	18, // 3: stream.video.sfu.event.SfuEvent.audio_level_changed:type_name -> stream.video.sfu.event.AudioLevelChanged
	25, // 4: stream.video.sfu.event.SfuEvent.ice_trickle:type_name -> stream.video.sfu.models.ICETrickle
	24, // 5: stream.video.sfu.event.SfuEvent.change_publish_quality:type_name -> stream.video.sfu.event.ChangePublishQuality
	...
	16, // 8: stream.video.sfu.event.SfuEvent.dominant_speaker_changed:type_name -> stream.video.sfu.event.DominantSpeakerChanged
	...
	26, // 14: stream.video.sfu.event.Error.error:type_name -> stream.video.sfu.models.Error
	27, // 15: stream.video.sfu.event.ICETrickle.peer_type:type_name -> stream.video.sfu.models.PeerType
	...
	28, // 18: stream.video.sfu.event.TrackPublished.type:type_name -> stream.video.sfu.models.TrackType
	28, // 19: stream.video.sfu.event.TrackUnpublished.type:type_name -> stream.video.sfu.models.TrackType
	29, // 20: stream.video.sfu.event.JoinResponse.call_state:type_name -> stream.video.sfu.models.CallState
	30, // 21: stream.video.sfu.event.ParticipantJoined.participant:type_name -> stream.video.sfu.models.Participant
	30, // 22: stream.video.sfu.event.ParticipantLeft.participant:type_name -> stream.video.sfu.models.Participant
	31, // 23: stream.video.sfu.event.ConnectionQualityChanged.connection_quality:type_name -> stream.video.sfu.models.ConnectionQuality
	17, // 24: stream.video.sfu.event.AudioLevelChanged.audio_levels:type_name -> stream.video.sfu.event.AudioLevel
	19, // 25: stream.video.sfu.event.AudioSender.media_request:type_name -> stream.video.sfu.event.AudioMediaRequest
	32, // 26: stream.video.sfu.event.AudioSender.codec:type_name -> stream.video.sfu.models.Codec
	0,  // 27: stream.video.sfu.event.VideoLayerSetting.priority:type_name -> stream.video.sfu.event.VideoLayerSetting.Priority
	32, // 28: stream.video.sfu.event.VideoLayerSetting.codec:type_name -> stream.video.sfu.models.Codec
	21, // 29: stream.video.sfu.event.VideoSender.media_request:type_name -> stream.video.sfu.event.VideoMediaRequest
	32, // 30: stream.video.sfu.event.VideoSender.codec:type_name -> stream.video.sfu.models.Codec
	22, // 31: stream.video.sfu.event.VideoSender.layers:type_name -> stream.video.sfu.event.VideoLayerSetting
	20, // 32: stream.video.sfu.event.ChangePublishQuality.audio_senders:type_name -> stream.video.sfu.event.AudioSender
	23, // 33: stream.video.sfu.event.ChangePublishQuality.video_senders:type_name -> stream.video.sfu.event.VideoSender

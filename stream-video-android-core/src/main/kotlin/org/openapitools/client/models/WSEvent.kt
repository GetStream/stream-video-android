 ...
 *
 * @param callCid * @param createdAt * @param type The type of event: \"connection.ok\" in this case
 * @param user * @param call * @param members The list of members that were updated
 ...
 * @param reaction * @param custom Custom data for this object

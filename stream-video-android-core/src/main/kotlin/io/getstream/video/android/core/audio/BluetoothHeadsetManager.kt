...
import io.getstream.video.android.core.audio.BluetoothHeadsetManager.HeadsetState.AudioActivated
import io.getstream.video.android.core.audio.BluetoothHeadsetManager.HeadsetState.AudioActivating
import io.getstream.video.android.core.audio.BluetoothHeadsetManager.HeadsetState.AudioActivationError
import io.getstream.video.android.core.audio.BluetoothHeadsetManager.HeadsetState.Connected
import io.getstream.video.android.core.audio.BluetoothHeadsetManager.HeadsetState.Disconnected
...
internal constructor(
    ...
    fun getHeadset(bluetoothHeadsetName: String?): io.getstream.video.android.core.audio.AudioDevice.BluetoothHeadset? {
        return if (hasPermissions()) {
            if (headsetState != Disconnected) {
                val headsetName = bluetoothHeadsetName ?: getHeadsetName()
                headsetName?.let { io.getstream.video.android.core.audio.AudioDevice.BluetoothHeadset(it) }
                    ?: io.getstream.video.android.core.audio.AudioDevice.BluetoothHeadset()
            } else
                null
        } else {
            null

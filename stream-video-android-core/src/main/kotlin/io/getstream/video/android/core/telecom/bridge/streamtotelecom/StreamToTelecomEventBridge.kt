...
internal interface StreamToTelecomEventBridgeFactory {
    fun create(telecomCall: TelecomCall): StreamToTelecomEventBridge
}

internal interface StreamToTelecomEventBridge {

...
internal class ServiceIntentBuilder {
    ...
    internal fun buildStartIntent(context: Context, startService: StartServiceParam): Intent {
    ...
    internal fun buildStopIntent(context: Context, stopServiceParam: StopServiceParam): Intent {

...
object SdpGrammar {
    ...
    fun tryParseOrigin(string: String): SdpOrigin? {
        ...
        return SdpOrigin(username, sessionId.toLong(), sessionVersion.toLong(), netType, ipVer.toLong(), address)
    }
    ...
    fun tryParseRtcp(string: String): SdpRtcp? {
        ...
        return SdpRtcp(port.toLong(), toOptionalString(netType), toOptionalLong(ipVer), toOptionalString(address))
    }
    ...
    fun tryParseCandidates(string: String): SdpCandidates? {
        ...
        return SdpCandidates(foundation, component.toLong(), transport, priority.toLong(), ip, port.toLong(), type, toOptionalString(raddr), toOptionalLong(rport), toOptionalString(tcptype), toOptionalLong(generation), toOptionalLong(networkId), toOptionalLong(networkCost))
    }
...
class SdpSession {
    ...
    fun write(): String {
        ...
        if (extmapAllowMixed != null) lines.add("a=" + SdpGrammar.writeExtmapallowmixed(extmapAllowMixed!!))
        crypto.forEach { item -> lines.add("a=" + SdpGrammar.writeCrypto(item))}
        if (setup != null) lines.add("a=" + SdpGrammar.writeSetup(setup!!))
        if (connectionType != null) lines.add("a=" + SdpGrammar.writeConnectiontype(connectionType!!))
        ...
        if (endOfCandidates != null) lines.add("a=" + SdpGrammar.writeEndofcandidates(endOfCandidates!!))
        if (remoteCandidates != null) lines.add("a=" + SdpGrammar.writeRemotecandidates(remoteCandidates!!))
        ...
        if (maxMessageSize != null) lines.add("a=" + SdpGrammar.writeMaxmessagesize(maxMessageSize!!))
        ...
        for (m in media) {
            ...
            if (m.extmapAllowMixed != null) lines.add("a=" + SdpGrammar.writeExtmapallowmixed(m.extmapAllowMixed!!))
            m.crypto.forEach { item -> lines.add("a=" + SdpGrammar.writeCrypto(item))}
            if (m.setup != null) lines.add("a=" + SdpGrammar.writeSetup(m.setup!!))
            if (m.connectionType != null) lines.add("a=" + SdpGrammar.writeConnectiontype(m.connectionType!!))
            ...
            if (m.endOfCandidates != null) lines.add("a=" + SdpGrammar.writeEndofcandidates(m.endOfCandidates!!))
            if (m.remoteCandidates != null) lines.add("a=" + SdpGrammar.writeRemotecandidates(m.remoteCandidates!!))
            ...
            if (m.msidSemantic != null) lines.add("a=" + SdpGrammar.writeMsidsemantic(m.msidSemantic!!))
            ...
            if (m.simulcast03 != null) lines.add("a=" + SdpGrammar.writeSimulcast03(m.simulcast03!!))
            ...
            if (m.maxMessageSize != null) lines.add("a=" + SdpGrammar.writeMaxmessagesize(m.maxMessageSize!!))
            ...
            if (m.bfcpFloorCtrl != null) lines.add("a=" + SdpGrammar.writeBfcpfloorctrl(m.bfcpFloorCtrl!!))
            ...
            if (m.bfcpFloorId != null) lines.add("a=" + SdpGrammar.writeBfcpfloorid(m.bfcpFloorId!!))
        ...
        when (type) {
            ...
            'b' -> {
                ...
                if (tryBandwidth != null) {
                    if (lastMedia != null) lastMedia.bandwidth.add(tryBandwidth) else bandwidth.add(tryBandwidth)
                return }
            }
            'm' -> {
            ...
            'a' -> {
                ...
                if (tryRtcpfbtrrint != null) {
                    if (lastMedia != null) lastMedia.rtcpFbTrrInt.add(tryRtcpfbtrrint) else rtcpFbTrrInt.add(tryRtcpfbtrrint)
                return }
                val tryRtcpfb = SdpGrammar.tryParseRtcpfb(value)
                if (tryRtcpfb != null) {
                    if (lastMedia != null) lastMedia.rtcpFb.add(tryRtcpfb) else rtcpFb.add(tryRtcpfb)
                return }
                ...
                if (tryCrypto != null) {
                    if (lastMedia != null) lastMedia.crypto.add(tryCrypto) else crypto.add(tryCrypto)
                return }
                ...
                if (tryCandidates != null) {
                    if (lastMedia != null) lastMedia.candidates.add(tryCandidates) else candidates.add(tryCandidates)
                return }
                ...
                if (trySsrcgroups != null) {
                    if (lastMedia != null) lastMedia.ssrcGroups.add(trySsrcgroups) else ssrcGroups.add(trySsrcgroups)
                return }
                ...
                if (tryGroups != null) {
                    if (lastMedia != null) lastMedia.groups.add(tryGroups) else groups.add(tryGroups)
                return }
                ...
                if (tryImageattrs != null) {
                    if (lastMedia != null) lastMedia.imageattrs.add(tryImageattrs) else imageattrs.add(tryImageattrs)
                return }
                ...
                if (tryTsrefclocks != null) {
                    if (lastMedia != null) lastMedia.tsRefClocks.add(tryTsrefclocks) else tsRefClocks.add(tryTsrefclocks)
                return }
                ...
                if (tryInvalid != null) {
                    if (lastMedia != null) lastMedia.invalid.add(tryInvalid) else invalid.add(tryInvalid)
                return }
            }
        }
    }

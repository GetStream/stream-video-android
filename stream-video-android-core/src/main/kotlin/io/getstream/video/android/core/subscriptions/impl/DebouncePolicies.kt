...
/**
 * Default debounce policies.
 */
internal object DebouncePolicies {
     ...
     */
    fun default(time: Long = 2000L): DebouncePolicy = object : DebouncePolicy {
        override fun debounceTime() = time
    }
}

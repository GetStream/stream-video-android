...
internal class TelecomNotificationUpdateObserver(
    ...
    onStartService = { _, _, _, _ ->
        // "Telecom notification ownership must not start CallService"
    },
) {
    ...
    override fun showOutgoingCallNotification(
        ...
        showNotification(
            callId = callId,
            notification = notification,
            fallbackType = NotificationType.Outgoing,
        )
    }
    ...
    override fun showIncomingCallNotification(
        ...
        showNotification(
            callId = callId,
            notification = notification,
            fallbackType = NotificationType.Incoming,
        )
    }
    ...
    private fun showNotification(
        ...
        streamVideo.getStreamNotificationDispatcher().notify(
            callId,
            notificationId,
            notification,
        )

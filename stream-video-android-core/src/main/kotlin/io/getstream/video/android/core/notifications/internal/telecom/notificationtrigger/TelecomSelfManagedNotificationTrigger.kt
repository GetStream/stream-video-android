...
class TelecomSelfManagedNotificationTrigger(private val serviceIntentBuilder: ServiceIntentBuilder = ServiceIntentBuilder()) {

    private val logger by taggedLogger("TelecomSelfManagedNotificationTrigger")

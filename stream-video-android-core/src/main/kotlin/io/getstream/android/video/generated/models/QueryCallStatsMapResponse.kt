...
data class QueryCallStatsMapResponse (
    @Json(name = "call_id")
    ...
    @Json(name = "end_time")
    val endTime: org.threeten.bp.OffsetDateTime? = null,

    @Json(name = "generated_at")
    val generatedAt: org.threeten.bp.OffsetDateTime? = null,

    @Json(name = "start_time")
    val startTime: org.threeten.bp.OffsetDateTime? = null,

    @Json(name = "publishers")
    val publishers: io.getstream.android.video.generated.models.CallStatsMapPublishers? = null,

    @Json(name = "sfus")
    val sfus: io.getstream.android.video.generated.models.CallStatsMapSFUs? = null,

    @Json(name = "subscribers")
    val subscribers: io.getstream.android.video.generated.models.CallStatsMapSubscribers? = null
)

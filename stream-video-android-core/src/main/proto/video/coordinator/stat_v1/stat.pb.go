...
const (
	...
	MediaType_MEDIA_TYPE_SCREEN_SHARE MediaType = 3
)
...
var (
	MediaType_name = map[int32]string{
		...
		1: "MEDIA_TYPE_AUDIO",
		2: "MEDIA_TYPE_VIDEO",
		3: "MEDIA_TYPE_SCREEN_SHARE",
	}
	MediaType_value = map[string]int32{
		"MEDIA_TYPE_UNSPECIFIED":  0,
		"MEDIA_TYPE_AUDIO":        1,
		"MEDIA_TYPE_VIDEO":        2,
		"MEDIA_TYPE_SCREEN_SHARE": 3,
	}
)
...
type TimelineEvent struct {
	...
	//
	//	*TimelineEvent_ParticipantConnected
	//	*TimelineEvent_ParticipantDisconnected
	//	*TimelineEvent_MediaStateChanged
	//	*TimelineEvent_Freeze
	Event isTimelineEvent_Event `protobuf_oneof:"event"`
}
...
func (m *TimelineEvent) GetEvent() isTimelineEvent_Event {
	if m != nil {
		return m.Event
	}
	return nil
...
func (x *TimelineEvent) GetParticipantConnected() *ParticipantConnected {
	if x, ok := x.GetEvent().(*TimelineEvent_ParticipantConnected); ok {
		return x.ParticipantConnected
	}
	return nil
}

func (x *TimelineEvent) GetParticipantDisconnected() *ParticipantDisconnected {
	if x, ok := x.GetEvent().(*TimelineEvent_ParticipantDisconnected); ok {
		return x.ParticipantDisconnected
	}
	return nil
}

func (x *TimelineEvent) GetMediaStateChanged() *MediaStateChanged {
	if x, ok := x.GetEvent().(*TimelineEvent_MediaStateChanged); ok {
		return x.MediaStateChanged
	}
	return nil
}

func (x *TimelineEvent) GetFreeze() *Freeze {
	if x, ok := x.GetEvent().(*TimelineEvent_Freeze); ok {
		return x.Freeze
	}
	return nil
}

type isTimelineEvent_Event interface {
	isTimelineEvent_Event()
}

type TimelineEvent_ParticipantConnected struct {
...
type TimelineEvent_ParticipantDisconnected struct {
...
type TimelineEvent_MediaStateChanged struct {
	MediaStateChanged *MediaStateChanged `protobuf:"bytes,4,opt,name=media_state_changed,json=mediaStateChanged,proto3,oneof"`
}

type TimelineEvent_Freeze struct {
	Freeze *Freeze `protobuf:"bytes,5,opt,name=freeze,proto3,oneof"`
}

func (*TimelineEvent_ParticipantConnected) isTimelineEvent_Event() {}

func (*TimelineEvent_ParticipantDisconnected) isTimelineEvent_Event() {}

func (*TimelineEvent_MediaStateChanged) isTimelineEvent_Event() {}

func (*TimelineEvent_Freeze) isTimelineEvent_Event() {}
...
func (x *CallParticipantTimeline) GetStart() *timestamppb.Timestamp {
	if x != nil {
		return x.Start
	}
	return nil
...
func (x *CallParticipantTimeline) GetEnd() *timestamppb.Timestamp {
	if x != nil {
		return x.End
	}
	return nil
...
func (x *CallParticipantTimeline) GetEvents() []*TimelineEvent {
	if x != nil {
		return x.Events
	}
	return nil
...
func (x *Session) Reset() {
	*x = Session{}
	if protoimpl.UnsafeEnabled {
		mi := &file_video_coordinator_stat_v1_stat_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Session) Descriptor() ([]byte, []int) {
	return file_video_coordinator_stat_v1_stat_proto_rawDescGZIP(), []int{6}
}
...
func (x *Session) GetCallId() string {
	if x != nil {
		return x.CallId
	}
	return ""
...
func (x *Session) GetCallType() string {
	if x != nil {
		return x.CallType
	}
	return ""
...
func (x *Session) GetEnd() *timestamppb.Timestamp {
	if x != nil {
		return x.End
	}
	return nil
...
var file_video_coordinator_stat_v1_stat_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d, 0x65,
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x03, 0x65, 0x6e, 0x64, 0x12, 0x47, 0x0a, 0x06, 0x65, 0x76,
	0x65, 0x6e, 0x74, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2f, 0x2e, 0x73, 0x74, 0x72,
	0x65, 0x61, 0x6d, 0x2e, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x2e, 0x63, 0x6f, 0x6f, 0x72, 0x64, 0x69,
	0x6e, 0x61, 0x74, 0x6f, 0x72, 0x2e, 0x73, 0x74, 0x61, 0x74, 0x5f, 0x76, 0x31, 0x2e, 0x54, 0x69,
	0x6d, 0x65, 0x6c, 0x69, 0x6e, 0x65, 0x45, 0x76, 0x65, 0x6e, 0x74, 0x52, 0x06, 0x65, 0x76, 0x65,
	0x6e, 0x74, 0x73, 0x22, 0xc7, 0x01, 0x0a, 0x07, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12,
	...
	0x73, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x17, 0x0a, 0x07, 0x63, 0x61, 0x6c, 0x6c, 0x5f,
	0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x63, 0x61, 0x6c, 0x6c, 0x49, 0x64,
	0x12, 0x1b, 0x0a, 0x09, 0x63, 0x61, 0x6c, 0x6c, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x08, 0x63, 0x61, 0x6c, 0x6c, 0x54, 0x79, 0x70, 0x65, 0x12, 0x30, 0x0a,
	...
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54,
	0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x03, 0x65, 0x6e, 0x64, 0x2a, 0x70, 0x0a,
	...
	,
	...
	,
}
...
var file_video_coordinator_stat_v1_stat_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_video_coordinator_stat_v1_stat_proto_goTypes = []interface{}{
	...
	(*TimelineEvent)(nil),           // 8: stream.video.coordinator.stat_v1.TimelineEvent
	(*CallParticipantTimeline)(nil), // 9: stream.video.coordinator.stat_v1.CallParticipantTimeline
	(*Session)(nil),                 // 10: stream.video.coordinator.stat_v1.Session
...
var file_video_coordinator_stat_v1_stat_proto_depIdxs = []int32{
	...
	11, // 1: stream.video.coordinator.stat_v1.Freeze.duration:type_name -> google.protobuf.Duration
	...
	12, // 6: stream.video.coordinator.stat_v1.TimelineEvent.timestamp:type_name -> google.protobuf.Timestamp
	4,  // 7: stream.video.coordinator.stat_v1.TimelineEvent.participant_connected:type_name -> stream.video.coordinator.stat_v1.ParticipantConnected
	5,  // 8: stream.video.coordinator.stat_v1.TimelineEvent.participant_disconnected:type_name -> stream.video.coordinator.stat_v1.ParticipantDisconnected
	7,  // 9: stream.video.coordinator.stat_v1.TimelineEvent.media_state_changed:type_name -> stream.video.coordinator.stat_v1.MediaStateChanged
	6,  // 10: stream.video.coordinator.stat_v1.TimelineEvent.freeze:type_name -> stream.video.coordinator.stat_v1.Freeze
	12, // 11: stream.video.coordinator.stat_v1.CallParticipantTimeline.start:type_name -> google.protobuf.Timestamp
	12, // 12: stream.video.coordinator.stat_v1.CallParticipantTimeline.end:type_name -> google.protobuf.Timestamp
	8,  // 13: stream.video.coordinator.stat_v1.CallParticipantTimeline.events:type_name -> stream.video.coordinator.stat_v1.TimelineEvent
	12, // 14: stream.video.coordinator.stat_v1.Session.start:type_name -> google.protobuf.Timestamp
	12, // 15: stream.video.coordinator.stat_v1.Session.end:type_name -> google.protobuf.Timestamp
...
func file_video_coordinator_stat_v1_stat_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_video_coordinator_stat_v1_stat_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
	...
	file_video_coordinator_stat_v1_stat_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*TimelineEvent_ParticipantConnected)(nil),
		(*TimelineEvent_ParticipantDisconnected)(nil),
		(*TimelineEvent_MediaStateChanged)(nil),
		(*TimelineEvent_Freeze)(nil),
	}
	type x struct{}

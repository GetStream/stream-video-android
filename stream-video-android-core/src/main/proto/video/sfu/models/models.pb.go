...
const (
	...
	SdkType_SDK_TYPE_PYTHON           SdkType = 10
	SdkType_SDK_TYPE_VISION_AGENTS    SdkType = 11
)
...
const (
	...
	ClientCapability_CLIENT_CAPABILITY_COORDINATOR_STATS ClientCapability = 2
)
...
var (
	ClientCapability_name = map[int32]string{
		...
		2: "CLIENT_CAPABILITY_COORDINATOR_STATS",
	}
...
const (
	DegradationPreference_DEGRADATION_PREFERENCE_UNSPECIFIED                       DegradationPreference = 0
	DegradationPreference_DEGRADATION_PREFERENCE_BALANCED                          DegradationPreference = 1
	DegradationPreference_DEGRADATION_PREFERENCE_MAINTAIN_FRAMERATE                DegradationPreference = 2
	DegradationPreference_DEGRADATION_PREFERENCE_MAINTAIN_RESOLUTION               DegradationPreference = 3
	DegradationPreference_DEGRADATION_PREFERENCE_MAINTAIN_FRAMERATE_AND_RESOLUTION DegradationPreference = 4
)

// Enum value maps for DegradationPreference.
var (
	DegradationPreference_name = map[int32]string{
		0: "DEGRADATION_PREFERENCE_UNSPECIFIED",
		1: "DEGRADATION_PREFERENCE_BALANCED",
		2: "DEGRADATION_PREFERENCE_MAINTAIN_FRAMERATE",
		3: "DEGRADATION_PREFERENCE_MAINTAIN_RESOLUTION",
		4: "DEGRADATION_PREFERENCE_MAINTAIN_FRAMERATE_AND_RESOLUTION",
	}
	DegradationPreference_value = map[string]int32{
		"DEGRADATION_PREFERENCE_UNSPECIFIED":                       0,
		"DEGRADATION_PREFERENCE_BALANCED":                          1,
		"DEGRADATION_PREFERENCE_MAINTAIN_FRAMERATE":                2,
		"DEGRADATION_PREFERENCE_MAINTAIN_RESOLUTION":               3,
		"DEGRADATION_PREFERENCE_MAINTAIN_FRAMERATE_AND_RESOLUTION": 4,
	}
)

func (x DegradationPreference) Enum() *DegradationPreference {
	p := new(DegradationPreference)
	*p = x
	return p
}

func (x DegradationPreference) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (DegradationPreference) Descriptor() protoreflect.EnumDescriptor {
	return file_video_sfu_models_models_proto_enumTypes[15].Descriptor()
}

func (DegradationPreference) Type() protoreflect.EnumType {
	return &file_video_sfu_models_models_proto_enumTypes[15]
}

func (x DegradationPreference) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use DegradationPreference.Descriptor instead.
func (DegradationPreference) EnumDescriptor() ([]byte, []int) {
...
type PublishOption struct {
	...
	DegradationPreference DegradationPreference `protobuf:"varint,11,opt,name=degradation_preference,json=degradationPreference,proto3,enum=stream.video.sfu.models.DegradationPreference" json:"degradation_preference,omitempty"`
}
...
func (x *PublishOption) GetDegradationPreference() DegradationPreference {
	if x != nil {
		return x.DegradationPreference
	}
	return DegradationPreference_DEGRADATION_PREFERENCE_UNSPECIFIED
}
...
type TrackInfo struct {
	...
	SelfSubAudioVideo bool   `protobuf:"varint,13,opt,name=self_sub_audio_video,json=selfSubAudioVideo,proto3" json:"self_sub_audio_video,omitempty"`
}
...
func (x *TrackInfo) GetSelfSubAudioVideo() bool {
	if x != nil {
		return x.SelfSubAudioVideo
	}
	return false
}
...
type ClientDetails struct {
	...
	WebrtcVersion string   `protobuf:"bytes,5,opt,name=webrtc_version,json=webrtcVersion,proto3" json:"webrtc_version,omitempty"`
}
...
func (x *ClientDetails) GetWebrtcVersion() string {
	if x != nil {
...
type RtpBase struct {
	...
	Ssrc        uint32  `protobuf:"varint,1,opt,name=ssrc,proto3" json:"ssrc,omitempty"`                                   // raw stat["ssrc"]
	Kind        string  `protobuf:"bytes,2,opt,name=kind,proto3" json:"kind,omitempty"`                                    // stat["kind"] ("audio","video")
	TimestampMs float64 `protobuf:"fixed64,3,opt,name=timestamp_ms,json=timestampMs,proto3" json:"timestamp_ms,omitempty"` // stat["timestamp"] in milliseconds
}

func (x *RtpBase) Reset() {
	*x = RtpBase{}
	if protoimpl.UnsafeEnabled {
		mi := &file_video_sfu_models_models_proto_msgTypes[26]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *RtpBase) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RtpBase) ProtoMessage() {}

func (x *RtpBase) ProtoReflect() protoreflect.Message {
	mi := &file_video_sfu_models_models_proto_msgTypes[26]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RtpBase.ProtoReflect.Descriptor instead.
func (*RtpBase) Descriptor() ([]byte, []int) {
	return file_video_sfu_models_models_proto_rawDescGZIP(), []int{26}
}

func (x *RtpBase) GetSsrc() uint32 {
	if x != nil {
		return x.Ssrc
	}
	return 0
...
func (x *RtpBase) GetTimestampMs() float64 {
	if x != nil {
...
type InboundRtp struct {
	...
	Base              *RtpBase `protobuf:"bytes,1,opt,name=base,proto3" json:"base,omitempty"`
	...
	// -------- VIDEO METRICS --------
	Fps                   float64 `protobuf:"fixed64,20,opt,name=fps,proto3" json:"fps,omitempty"`                                                                    // use delta(framesDecoded)/delta(time) with prev sample
	FreezeDurationSeconds float64 `protobuf:"fixed64,21,opt,name=freeze_duration_seconds,json=freezeDurationSeconds,proto3" json:"freeze_duration_seconds,omitempty"` // stat["totalFreezesDuration"]
	AvgDecodeTimeSeconds  float64 `protobuf:"fixed64,22,opt,name=avg_decode_time_seconds,json=avgDecodeTimeSeconds,proto3" json:"avg_decode_time_seconds,omitempty"`  // stat["totalDecodeTime"] / max(1, stat["framesDecoded"])
	MinDimensionPx        uint32  `protobuf:"varint,23,opt,name=min_dimension_px,json=minDimensionPx,proto3" json:"min_dimension_px,omitempty"`                       // min(stat["frameWidth"], stat["frameHeight"]) for video-like tracks
}

func (x *InboundRtp) Reset() {
	*x = InboundRtp{}
	if protoimpl.UnsafeEnabled {
		mi := &file_video_sfu_models_models_proto_msgTypes[27]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *InboundRtp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InboundRtp) ProtoMessage() {}

func (x *InboundRtp) ProtoReflect() protoreflect.Message {
	mi := &file_video_sfu_models_models_proto_msgTypes[27]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InboundRtp.ProtoReflect.Descriptor instead.
func (*InboundRtp) Descriptor() ([]byte, []int) {
	return file_video_sfu_models_models_proto_rawDescGZIP(), []int{27}
}

func (x *InboundRtp) GetBase() *RtpBase {
	if x != nil {
		return x.Base
	}
	return nil
...
func (x *InboundRtp) GetJitterSeconds() float64 {
	if x != nil {
...
func (x *InboundRtp) GetPacketsReceived() uint64 {
	if x != nil {
...
func (x *InboundRtp) GetPacketsLost() uint64 {
	if x != nil {
...
func (x *InboundRtp) GetPacketLossPercent() float64 {
	if x != nil {
...
func (x *InboundRtp) GetConcealmentEvents() uint32 {
	if x != nil {
...
func (x *InboundRtp) GetConcealmentPercent() float64 {
	if x != nil {
		return x.ConcealmentPercent
	}
	return 0
}

func (x *InboundRtp) GetFps() float64 {
	if x != nil {
		return x.Fps
	}
	return 0
...
func (x *InboundRtp) GetFreezeDurationSeconds() float64 {
	if x != nil {
		return x.FreezeDurationSeconds
	}
	return 0
}

func (x *InboundRtp) GetAvgDecodeTimeSeconds() float64 {
	if x != nil {
		return x.AvgDecodeTimeSeconds
	}
	return 0
}

func (x *InboundRtp) GetMinDimensionPx() uint32 {
	if x != nil {
		return x.MinDimensionPx
	}
	return 0
}
...
type OutboundRtp struct {
	...
	Base                 *RtpBase `protobuf:"bytes,1,opt,name=base,proto3" json:"base,omitempty"`
	Fps                  float64  `protobuf:"fixed64,10,opt,name=fps,proto3" json:"fps,omitempty"`                                                                   // delta(framesEncoded)/delta(time) if missing
	AvgEncodeTimeSeconds float64  `protobuf:"fixed64,11,opt,name=avg_encode_time_seconds,json=avgEncodeTimeSeconds,proto3" json:"avg_encode_time_seconds,omitempty"` // stat["totalEncodeTime"] / max(1, stat["framesEncoded"])
	BitrateBps           float64  `protobuf:"fixed64,12,opt,name=bitrate_bps,json=bitrateBps,proto3" json:"bitrate_bps,omitempty"`                                   // delta(bytesSent)*8 / delta(timeSeconds); requires prev bytes/timestamp; ignore if delta<=0
	MinDimensionPx       uint32   `protobuf:"varint,13,opt,name=min_dimension_px,json=minDimensionPx,proto3" json:"min_dimension_px,omitempty"`                      // min(stat["frameWidth"], stat["frameHeight"])
}

func (x *OutboundRtp) Reset() {
	*x = OutboundRtp{}
	if protoimpl.UnsafeEnabled {
		mi := &file_video_sfu_models_models_proto_msgTypes[28]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *OutboundRtp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OutboundRtp) ProtoMessage() {}

func (x *OutboundRtp) ProtoReflect() protoreflect.Message {
	mi := &file_video_sfu_models_models_proto_msgTypes[28]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OutboundRtp.ProtoReflect.Descriptor instead.
func (*OutboundRtp) Descriptor() ([]byte, []int) {
	return file_video_sfu_models_models_proto_rawDescGZIP(), []int{28}
}

func (x *OutboundRtp) GetBase() *RtpBase {
	if x != nil {
		return x.Base
	}
	return nil
...
func (x *OutboundRtp) GetFps() float64 {
	if x != nil {
		return x.Fps
	}
	return 0
...
func (x *OutboundRtp) GetAvgEncodeTimeSeconds() float64 {
	if x != nil {
		return x.AvgEncodeTimeSeconds
	}
	return 0
}

func (x *OutboundRtp) GetBitrateBps() float64 {
	if x != nil {
		return x.BitrateBps
	}
	return 0
...
func (x *OutboundRtp) GetMinDimensionPx() uint32 {
	if x != nil {
		return x.MinDimensionPx
	}
	return 0
...
type RemoteInboundRtp struct {
	...
	Base           *RtpBase `protobuf:"bytes,1,opt,name=base,proto3" json:"base,omitempty"`
	JitterSeconds  float64  `protobuf:"fixed64,2,opt,name=jitter_seconds,json=jitterSeconds,proto3" json:"jitter_seconds,omitempty"`        // stat["jitter"]
	RoundTripTimeS float64  `protobuf:"fixed64,3,opt,name=round_trip_time_s,json=roundTripTimeS,proto3" json:"round_trip_time_s,omitempty"` // stat["roundTripTime"]
}

func (x *RemoteInboundRtp) Reset() {
	*x = RemoteInboundRtp{}
	if protoimpl.UnsafeEnabled {
		mi := &file_video_sfu_models_models_proto_msgTypes[29]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *RemoteInboundRtp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RemoteInboundRtp) ProtoMessage() {}

func (x *RemoteInboundRtp) ProtoReflect() protoreflect.Message {
	mi := &file_video_sfu_models_models_proto_msgTypes[29]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RemoteInboundRtp.ProtoReflect.Descriptor instead.
func (*RemoteInboundRtp) Descriptor() ([]byte, []int) {
	return file_video_sfu_models_models_proto_rawDescGZIP(), []int{29}
}

func (x *RemoteInboundRtp) GetBase() *RtpBase {
	if x != nil {
		return x.Base
	}
	return nil
...
func (x *RemoteInboundRtp) GetJitterSeconds() float64 {
	if x != nil {
		return x.JitterSeconds
	}
	return 0
...
func (x *RemoteInboundRtp) GetRoundTripTimeS() float64 {
	if x != nil {
...
// ===================================================================
type RemoteOutboundRtp struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Base           *RtpBase `protobuf:"bytes,1,opt,name=base,proto3" json:"base,omitempty"`
	JitterSeconds  float64  `protobuf:"fixed64,2,opt,name=jitter_seconds,json=jitterSeconds,proto3" json:"jitter_seconds,omitempty"`        // stat["jitter"] if provided
	RoundTripTimeS float64  `protobuf:"fixed64,3,opt,name=round_trip_time_s,json=roundTripTimeS,proto3" json:"round_trip_time_s,omitempty"` // stat["roundTripTime"]
}

func (x *RemoteOutboundRtp) Reset() {
	*x = RemoteOutboundRtp{}
	if protoimpl.UnsafeEnabled {
		mi := &file_video_sfu_models_models_proto_msgTypes[30]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *RemoteOutboundRtp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RemoteOutboundRtp) ProtoMessage() {}

func (x *RemoteOutboundRtp) ProtoReflect() protoreflect.Message {
	mi := &file_video_sfu_models_models_proto_msgTypes[30]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RemoteOutboundRtp.ProtoReflect.Descriptor instead.
func (*RemoteOutboundRtp) Descriptor() ([]byte, []int) {
	return file_video_sfu_models_models_proto_rawDescGZIP(), []int{30}
}

func (x *RemoteOutboundRtp) GetBase() *RtpBase {
	if x != nil {
		return x.Base
	}
	return nil
...
func (x *RemoteOutboundRtp) GetJitterSeconds() float64 {
	if x != nil {
		return x.JitterSeconds
	}
	return 0
...
func (x *RemoteOutboundRtp) GetRoundTripTimeS() float64 {
	if x != nil {
		return x.RoundTripTimeS
	}
	return 0
...
var file_video_sfu_models_models_proto_rawDesc = []byte{
	...
	0x63, 0x73, 0x22, 0xe2, 0x04, 0x0a, 0x0d, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x4f, 0x70,
	...
	,
	...
	,
	...
	0x65, 0x22, 0x37, 0x0a, 0x07, 0x42, 0x72, 0x6f, 0x77, 0x73, 0x65, 0x72, 0x12, 0x12, 0x0a, 0x04,
	0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65,
	0x12, 0x18, 0x0a, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x22, 0xcb, 0x01, 0x0a, 0x0b, 0x52,
	0x54, 0x4d, 0x50, 0x49, 0x6e, 0x67, 0x72, 0x65, 0x73, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x77, 0x69,
	...
	,
	...
	0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x63, 0x72, 0x65, 0x61, 0x74,
	0x65, 0x64, 0x42, 0x79, 0x55, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x20, 0x0a, 0x0c, 0x68, 0x6f,
	0x73, 0x74, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x0a, 0x68, 0x6f, 0x73, 0x74, 0x55, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x2f, 0x0a, 0x06,
	0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x67,
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x53,
	0x74, 0x72, 0x75, 0x63, 0x74, 0x52, 0x06, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x12, 0x39, 0x0a,
	...
	,
	...
	,
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0b, 0x70, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x73, 0x4c,
	0x6f, 0x73, 0x74, 0x12, 0x2e, 0x0a, 0x13, 0x70, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x5f, 0x6c, 0x6f,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x76, 0x31, 0x2e, 0x53, 0x66, 0x75, 0x2e, 0x4d, 0x6f, 0x64, 0x65, 0x6c, 0x73, 0x62, 0x06, 0x70,
...
var file_video_sfu_models_models_proto_enumTypes = make([]protoimpl.EnumInfo, 16)
var file_video_sfu_models_models_proto_msgTypes = make([]protoimpl.MessageInfo, 31)
var file_video_sfu_models_models_proto_goTypes = []interface{}{
	...
	(DegradationPreference)(0),      // 15: stream.video.sfu.models.DegradationPreference
	(*CallState)(nil),               // 16: stream.video.sfu.models.CallState
	(*ParticipantCount)(nil),        // 17: stream.video.sfu.models.ParticipantCount
	(*Pin)(nil),                     // 18: stream.video.sfu.models.Pin
	(*Participant)(nil),             // 19: stream.video.sfu.models.Participant
	(*StreamQuality)(nil),           // 20: stream.video.sfu.models.StreamQuality
	(*VideoDimension)(nil),          // 21: stream.video.sfu.models.VideoDimension
	(*VideoLayer)(nil),              // 22: stream.video.sfu.models.VideoLayer
	(*SubscribeOption)(nil),         // 23: stream.video.sfu.models.SubscribeOption
	(*PublishOption)(nil),           // 24: stream.video.sfu.models.PublishOption
	(*Codec)(nil),                   // 25: stream.video.sfu.models.Codec
	(*ICETrickle)(nil),              // 26: stream.video.sfu.models.ICETrickle
	(*AudioBitrate)(nil),            // 27: stream.video.sfu.models.AudioBitrate
	(*TrackInfo)(nil),               // 28: stream.video.sfu.models.TrackInfo
	(*Error)(nil),                   // 29: stream.video.sfu.models.Error
	(*ClientDetails)(nil),           // 30: stream.video.sfu.models.ClientDetails
	(*Sdk)(nil),                     // 31: stream.video.sfu.models.Sdk
	(*OS)(nil),                      // 32: stream.video.sfu.models.OS
	(*Browser)(nil),                 // 33: stream.video.sfu.models.Browser
	(*RTMPIngress)(nil),             // 34: stream.video.sfu.models.RTMPIngress
	(*Device)(nil),                  // 35: stream.video.sfu.models.Device
	(*Call)(nil),                    // 36: stream.video.sfu.models.Call
	(*CallGrants)(nil),              // 37: stream.video.sfu.models.CallGrants
	(*InputDevices)(nil),            // 38: stream.video.sfu.models.InputDevices
	(*AndroidState)(nil),            // 39: stream.video.sfu.models.AndroidState
	(*AppleState)(nil),              // 40: stream.video.sfu.models.AppleState
	(*PerformanceStats)(nil),        // 41: stream.video.sfu.models.PerformanceStats
	(*RtpBase)(nil),                 // 42: stream.video.sfu.models.RtpBase
	(*InboundRtp)(nil),              // 43: stream.video.sfu.models.InboundRtp
	(*OutboundRtp)(nil),             // 44: stream.video.sfu.models.OutboundRtp
	(*RemoteInboundRtp)(nil),        // 45: stream.video.sfu.models.RemoteInboundRtp
	(*RemoteOutboundRtp)(nil),       // 46: stream.video.sfu.models.RemoteOutboundRtp
	(*timestamppb.Timestamp)(nil),   // 47: google.protobuf.Timestamp
	(*structpb.Struct)(nil),         // 48: google.protobuf.Struct
}
var file_video_sfu_models_models_proto_depIdxs = []int32{
	19, // 0: stream.video.sfu.models.CallState.participants:type_name -> stream.video.sfu.models.Participant
	47, // 1: stream.video.sfu.models.CallState.started_at:type_name -> google.protobuf.Timestamp
	17, // 2: stream.video.sfu.models.CallState.participant_count:type_name -> stream.video.sfu.models.ParticipantCount
	18, // 3: stream.video.sfu.models.CallState.pins:type_name -> stream.video.sfu.models.Pin
	3,  // 4: stream.video.sfu.models.Participant.published_tracks:type_name -> stream.video.sfu.models.TrackType
	47, // 5: stream.video.sfu.models.Participant.joined_at:type_name -> google.protobuf.Timestamp
	1,  // 6: stream.video.sfu.models.Participant.connection_quality:type_name -> stream.video.sfu.models.ConnectionQuality
	48, // 7: stream.video.sfu.models.Participant.custom:type_name -> google.protobuf.Struct
	...
	21, // 10: stream.video.sfu.models.VideoLayer.video_dimension:type_name -> stream.video.sfu.models.VideoDimension
	...
	25, // 13: stream.video.sfu.models.SubscribeOption.codecs:type_name -> stream.video.sfu.models.Codec
	3,  // 14: stream.video.sfu.models.PublishOption.track_type:type_name -> stream.video.sfu.models.TrackType
	25, // 15: stream.video.sfu.models.PublishOption.codec:type_name -> stream.video.sfu.models.Codec
	21, // 16: stream.video.sfu.models.PublishOption.video_dimension:type_name -> stream.video.sfu.models.VideoDimension
	27, // 17: stream.video.sfu.models.PublishOption.audio_bitrate_profiles:type_name -> stream.video.sfu.models.AudioBitrate
	15, // 18: stream.video.sfu.models.PublishOption.degradation_preference:type_name -> stream.video.sfu.models.DegradationPreference
	0,  // 19: stream.video.sfu.models.ICETrickle.peer_type:type_name -> stream.video.sfu.models.PeerType
	5,  // 20: stream.video.sfu.models.AudioBitrate.profile:type_name -> stream.video.sfu.models.AudioBitrateProfile
	3,  // 21: stream.video.sfu.models.TrackInfo.track_type:type_name -> stream.video.sfu.models.TrackType
	22, // 22: stream.video.sfu.models.TrackInfo.layers:type_name -> stream.video.sfu.models.VideoLayer
	25, // 23: stream.video.sfu.models.TrackInfo.codec:type_name -> stream.video.sfu.models.Codec
	6,  // 24: stream.video.sfu.models.Error.code:type_name -> stream.video.sfu.models.ErrorCode
	31, // 25: stream.video.sfu.models.ClientDetails.sdk:type_name -> stream.video.sfu.models.Sdk
	32, // 26: stream.video.sfu.models.ClientDetails.os:type_name -> stream.video.sfu.models.OS
	33, // 27: stream.video.sfu.models.ClientDetails.browser:type_name -> stream.video.sfu.models.Browser
	35, // 28: stream.video.sfu.models.ClientDetails.device:type_name -> stream.video.sfu.models.Device
	7,  // 29: stream.video.sfu.models.Sdk.type:type_name -> stream.video.sfu.models.SdkType
	48, // 30: stream.video.sfu.models.Call.custom:type_name -> google.protobuf.Struct
	47, // 31: stream.video.sfu.models.Call.created_at:type_name -> google.protobuf.Timestamp
	47, // 32: stream.video.sfu.models.Call.updated_at:type_name -> google.protobuf.Timestamp
	12, // 33: stream.video.sfu.models.AndroidState.thermal_state:type_name -> stream.video.sfu.models.AndroidThermalState
	13, // 34: stream.video.sfu.models.AppleState.thermal_state:type_name -> stream.video.sfu.models.AppleThermalState
	3,  // 35: stream.video.sfu.models.PerformanceStats.track_type:type_name -> stream.video.sfu.models.TrackType
	25, // 36: stream.video.sfu.models.PerformanceStats.codec:type_name -> stream.video.sfu.models.Codec
	21, // 37: stream.video.sfu.models.PerformanceStats.video_dimension:type_name -> stream.video.sfu.models.VideoDimension
	42, // 38: stream.video.sfu.models.InboundRtp.base:type_name -> stream.video.sfu.models.RtpBase
	42, // 39: stream.video.sfu.models.OutboundRtp.base:type_name -> stream.video.sfu.models.RtpBase
	42, // 40: stream.video.sfu.models.RemoteInboundRtp.base:type_name -> stream.video.sfu.models.RtpBase
	42, // 41: stream.video.sfu.models.RemoteOutboundRtp.base:type_name -> stream.video.sfu.models.RtpBase
...
func file_video_sfu_models_models_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_video_sfu_models_models_proto_msgTypes[26].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RtpBase); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_video_sfu_models_models_proto_msgTypes[27].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*InboundRtp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_video_sfu_models_models_proto_msgTypes[28].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*OutboundRtp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_video_sfu_models_models_proto_msgTypes[29].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RemoteInboundRtp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_video_sfu_models_models_proto_msgTypes[30].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RemoteOutboundRtp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache

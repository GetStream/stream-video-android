...
# legacy-defaults keeps the field defaults our public models already have:
# optional List/Map/Set fields default to an empty collection, and schema
# defaults (e.g. event `type`) are not applied. The generator now defaults

...
OUTPUT_CLIENT_PATH="$PROJECT_ROOT/stream-video-android-core/src/main/kotlin/org/openapitools/client/"

# Set environment variables
export APP_CONFIG_FILE="configs/test.yaml"

# Step 1: Clone the repository with shallow depth
...
# Step 2: Checkout to the correct branch, tag, or commit
...
# Step 3: Run the Go program with OpenAPI arguments
...
# Step 4: Delete directory and keep classes
...
go run ./cmd/chat-manager openapi generate-client \
  ...
  --output "$OUTPUT_CLIENT_PATH"

echo "👉 Your autogenerated files are available under $OUTPUT_CLIENT_PATH"

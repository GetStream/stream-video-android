...
public data class StreamDimens(
    ...
    public companion object {
        ...
        public fun defaultDimens(): StreamDimens = StreamDimens(
            ...
            callParticipantLabelTextPadding = dimensionResource(id = R.dimen.stream_video_callParticipantLabelTextPadding),
            callParticipantSoundIndicatorPaddingStart = dimensionResource(id = R.dimen.stream_video_callParticipantSoundIndicatorPaddingStart),
